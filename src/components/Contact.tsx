  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="inline-block px-8 py-3 border border-accent text-accent text-sm font-medium rounded hover:bg-accent/10 transition-colors"
      >
        Say Hello
      </a>
      ...
      <div className="mt-16 flex justify-center gap-8">
        <a
          href="https://github.com/AadityaMishra1"
          target="_blank"
        ...
        <a
          href="https://linkedin.com/in/aaditya-mishra-ncsu"
          target="_blank"
          rel="noopener noreferrer"
          className="text-text-secondary hover:text-accent transition-colors"
          aria-label="LinkedIn"
